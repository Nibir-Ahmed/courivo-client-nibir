...
const allCourses = [
  ...
  { _id: '7', title: 'Machine Learning A-Z', category: 'Data Science', price: 64, duration: '18h 00m', imageUrl: 'https://images.unsplash.com/photo-1555949963-ff9fe0c870eb?w=500' },
  { _id: '8', title: 'Figma for Beginners', category: 'Design', price: 29, duration: '5h 30m', imageUrl: 'https://images.unsplash.com/photo-1586717791821-3f44a563fa4c?w=500' },
];
...
const Courses = () => {
  ...
  const filtered = selected === 'All'
    ? allCourses
    : allCourses.filter(c => c.category === selected);
